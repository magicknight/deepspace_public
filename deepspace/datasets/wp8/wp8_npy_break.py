...
class Loader:
    def __init__(self):
        ...
        # split dataset
        train_dataset = Dataset(path=config.deepspace.train_dataset, train_transform=self.train_trainsform, target_transform=self.target_transform)
        ...
        test_dataset = DatasetTest(path=config.deepspace.test_dataset, transform=self.test_transform)
