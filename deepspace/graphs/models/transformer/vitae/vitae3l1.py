...
if __name__ == "__main__":
    ...
    model = VITAE(image_size=768, patch_size=32, dim=1024, depth=4, heads=16, in_channels=5, out_channels=1, dim_head=64, dropout=0.1, emb_dropout=0.1, scale_dim=8)
