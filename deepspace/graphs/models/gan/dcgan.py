...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.conv5 = nn.Conv2d(in_channels=config.deepspace.num_filt_d*8, out_channels=config.deepspace.num_filt_d*16, kernel_size=4, stride=2, padding=1, bias=False)
        self.batch_norm4 = nn.BatchNorm2d(config.deepspace.num_filt_d*16)

        self.conv6 = nn.Conv2d(in_channels=config.deepspace.num_filt_d*16, out_channels=config.deepspace.num_filt_d*32, kernel_size=4, stride=2, padding=1, bias=False)
        self.batch_norm5 = nn.BatchNorm2d(config.deepspace.num_filt_d*32)

        self.conv7 = nn.Conv2d(in_channels=config.deepspace.num_filt_d*32, out_channels=config.deepspace.num_filt_d*64, kernel_size=4, stride=2, padding=1, bias=False)
        self.batch_norm6 = nn.BatchNorm2d(config.deepspace.num_filt_d*64)

        self.conv9 = nn.Conv2d(in_channels=config.deepspace.num_filt_d*64, out_channels=1, kernel_size=4, stride=1, padding=0, bias=False)
