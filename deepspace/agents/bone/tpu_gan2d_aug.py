...
from deepspace.augmentation.diff_aug_more import DiffAugment
...
class Agent(BasicAgent):
    def __init__(self, **kwargs):
        ...
        self.generator.apply(kaiming_weights_v2)
        self.discriminator.apply(kaiming_weights_v2)
    ...
    def train_one_epoch(self):
        ...
        for input_images, target_images in tqdm_batch:
            ...
            out_labels_fake = self.discriminator(DiffAugment(fake_images.detach(), policy=config.deepspace.policy))
            # out_labels_fake = self.discriminator(fake_images.detach())
