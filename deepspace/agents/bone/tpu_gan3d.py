...
from deepspace.datasets.voxel.npy3d import Loader
...
if config.deepspace.mode == "train":
    ...
    from deepspace.graphs.models.autoencoder.ae3d_ge_test import Residual3DAE
...
class Agent(BasicAgent):
    ...
    def train(self):
        ...
        for epoch in range(self.current_epoch, config.deepspace.max_epoch):
            ...
            # skip validation if not on the correct epoch
    ...
    def test(self):
        ...
        recon_data = rearrange(
            recon_data,
            "(n1 n2 n3) b1 b2 b3 -> (n1 b1) (n2 b2) (n3 b3)",
